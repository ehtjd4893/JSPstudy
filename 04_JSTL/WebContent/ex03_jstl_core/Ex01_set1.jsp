...
<%--
	...
	1. 지시어를 작성해야 한다.
		<%@ 지시어 %>
	2. 다음과 같이 작성한다.
		<%@ taglib uri="http://java.sun.com" prefix="c" %>
...
<body>	
	...
	<c:set var="age" value="50" /> <%-- scope를 생략하면 pageContext에 저장됨. --%>
	...
	%>
	<c:set var="phone" value="010-1234-5678" scope="request"/>
